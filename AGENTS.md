...
**In kubestream (Task 2.4):** both options ship, but the chart is **hand-written**
at `deploy/charts/kubestream`, not generated by the `helm/v2-alpha` plugin — do not
...
`make build-installer` with no arguments. `deploy/charts/kubestream/README.md`
